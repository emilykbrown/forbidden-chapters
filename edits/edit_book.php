            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" name="isbn" id="isbn" value="<?php echo $isbn; ?>" placeholder="ISBN">
                    </div>
                    <span class="error">
                        <?php echo $isbnError; ?>
                    </span>
                    <div class="mb-3 mt-3">
                        ...
                        <select name="author_select" class="form-control select-control" id="author_select" value="
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <select name="genre_select" class="form-control select-control" id="genre_select" value="<?php echo $genre; ?>">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <textarea class="form-control" id="blurb" name="blurb" rows="3" placeholder="Blurb" value="<?php echo $blurb; ?>"></textarea>
                    </div>
                    <span class="error">
                        <?php echo $blurbError; ?>
                    </span>
                    <div class="row">
                        ...
                        <div class="mb-3 mt-3 col">
                            ...
                            <input type="number" class="form-control" id="qty" value="<?php echo $qty; ?>" name="qty" min="1" max="10000">
                            <span class="error">
                                <?php echo $qtyError; ?>
                            </span>
                        </div>
                    ...
                    <div class="d-grid gap-4">
                        <button type="submit" name="add-book" value="add-book" class="btn btn-success">Update Book</button>
                    </div>
                </form>
            </div>
        </div>
